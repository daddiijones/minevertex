      ...
      <div className="stats-grid" style={{ marginBottom: 24 }}>
        <div className="stat-card">
          <div className="stat-card-header">
            <div><div className="stat-value" style={{ color: 'var(--success)' }}>+${fmt(totalCredits)}</div><div className="stat-label">Total Credits</div></div>
            <div className="stat-icon green"><ArrowDownToLine size={20} /></div>
          </div>
        </div>
        <div className="stat-card">
          <div className="stat-card-header">
            <div><div className="stat-value" style={{ color: 'var(--danger)' }}>-${fmt(totalDebits)}</div><div className="stat-label">Total Debits</div></div>
